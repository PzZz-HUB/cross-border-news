...
def filter_news_with_ai(news_list):
    ...
    prompt += "挑选标准：\n"
    prompt += "- 广泛保留所有有价值的新鲜事：只要是与【跨境、出海、外贸、全球化】相关的任何重要资讯（不仅限于跨境电商，还包括品牌出海、游戏/应用出海、跨境支付、物流海关、海外市场动态等），只要你认为从事跨境相关业务的人看了会有启发或能了解宏观行业动态，就必须保留！\n"
    prompt += "- 坚决剔除：任何卖课、招商大会、拉群、无价值的纯服务商引流广告。\n"
